...
cursor = db.cursor()
sql_createtable = "create table certificate_afrinic_"+str(datetime.date.today().year)+"_"+str('{:02d}'.format(datetime.date.today().month))+"_"+str('{:02d}'.format(datetime.date.today().day))+" (Cert_name varchar(100), Cert_URI varchar(200) primary key, Auth_URI varchar(200), Sub_URI varchar(200), Content longtext, id varchar(20));"
cursor.execute(sql_createtable)
sql_createtable = "create table roa_afrinic_"+str(datetime.date.today().year)+"_"+str('{:02d}'.format(datetime.date.today().month))+"_"+str('{:02d}'.format(datetime.date.today().day))+" (ROA_name varchar(100), ROA_URI varchar(200) primary key, Cert_URI varchar(200), Content longtext, id varchar(20), foreign key(Cert_URI) references certificate_ripe_"+str(datetime.date.today().year)+"_"+str('{:02d}'.format(datetime.date.today().month))+"_"+str('{:02d}'.format(datetime.date.today().day))+"(Cert_URI));"
cursor.execute(sql_createtable)
sql_createtable = "create table asn_ip_afrinic_"+str(datetime.date.today().year)+"_"+str('{:02d}'.format(datetime.date.today().month))+"_"+str('{:02d}'.format(datetime.date.today().day))+" (ASN varchar(10), IP_block varchar(50), version varchar(5), max_length varchar(5), ROA_URI varchar(200), id varchar(20), foreign key (ROA_URI) references roa_ripe_"+str(datetime.date.today().year)+"_"+str('{:02d}'.format(datetime.date.today().month))+"_"+str('{:02d}'.format(datetime.date.today().day))+"(ROA_URI));"
cursor.execute(sql_createtable)
file_dir = "RPKI_code/rpki_afrinic_"+str(datetime.date.today().year)+"_"+str('{:02d}'.format(datetime.date.today().month))+"_"+str('{:02d}'.format(datetime.date.today().day))+""
...
mysql = time.time()
try:
    sql_1 = "insert into certificate_afrinic_"+str(datetime.date.today().year)+"_"+str('{:02d}'.format(datetime.date.today().month))+"_"+str('{:02d}'.format(datetime.date.today().day))+" values(%s, %s, %s, %s, %s, %s);"
    ...
    cursor.connection.commit()
try:
    sql_2 = "insert into roa_afrinic_"+str(datetime.date.today().year)+"_"+str('{:02d}'.format(datetime.date.today().month))+"_"+str('{:02d}'.format(datetime.date.today().day))+" values(%s, %s, %s, %s, %s);"
    ...
    cursor.connection.commit()
try:
    sql_3 = "insert into asn_ip_afrinic_"+str(datetime.date.today().year)+"_"+str('{:02d}'.format(datetime.date.today().month))+"_"+str('{:02d}'.format(datetime.date.today().day))+" values(%s, %s, %s, %s, %s, %s);"
